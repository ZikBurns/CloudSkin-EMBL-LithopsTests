...
directory_path = 'benchmarks_3008/time_results_clean'
results=[]
for entry in os.scandir(directory_path):
    if entry.is_file():
        ...
        if "cold" in entry.path:
            time_model_init=8.858225595335242
        else:
            time_model_init=0.36915580841915946
        durations=[]
        for subentry in os.scandir(entry.path):
            if subentry.is_file():
                ...
                with open(subentry.path, 'r') as file:
                    ...
                    duration = last_end-first_start-5+time_model_init
...
print(results)
with open("benchmarks_3008/time_results_clean_plus_model_init.json", "w") as file:
...
file_path = "benchmarks_3008/time_results_clean_plus_model_init.csv"

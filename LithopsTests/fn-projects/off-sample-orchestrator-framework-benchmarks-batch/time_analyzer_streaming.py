...
directory_path = 'streaming_benchmarks/time_results_15_9_23_threading/percentile_90'
results=[]
...
print(results)
with open("streaming_benchmarks/time_results_14_9_23_threading.json", "w") as file:
    json.dump(results,file,indent=6)

fieldnames = results[0].keys()
file_path = "streaming_benchmarks/time_results_14_9_23_threading.csv"
